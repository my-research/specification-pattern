...
class PeriodTest {
    ...
    public static final int FEE_HALF = 50;
    ...
    void 기간에_따른_환불() {
        ...
        assertThat(fee).isEqualTo(FEE_HALF);
    }
    ...
    public static List<Meeting> loadMeetingsByMembershipId(Long membershipId) {
        ...
        return List.of(Meeting.of(membershipId, firstMeeting), Meeting.of(membershipId, secondMeeting));
    }
}